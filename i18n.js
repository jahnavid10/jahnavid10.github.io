const translations = {
  en: {
    ...
    "exp.r1.li2": "Established the practical accuracy–compression boundary for on-device edge deployment via downstream Human Activity Recognition (Tiny-HAR) performance across compression levels.",
  ...
  de: {
    ...
    "exp.r1.li2": "Praktische Grenze zwischen Genauigkeit und Kompression für Edge-Deployment ermittelt, gemessen anhand der Human-Activity-Recognition-Leistung (Tiny-HAR) über verschiedene Kompressionsstufen.",
    ...
    "thesis.desc": "Vier Kompressionsverfahren für 12-Kanal-Wearable-Sensordaten verglichen und die Datenmenge um 97 % reduziert, während die praktische Grenze zwischen Genauigkeit und Kompression für On-Device Human Activity Recognition ermittelt wurde. Ein browserbasiertes Visualisierungstool mit 100 FPS und einer Decodier-Latenz unter 50 ms für die interaktive Zeitreihen-Exploration entwickelt.",
